...
function Termspage() {
  return (
    <section className="policy-page">
      ...
      <ul>
        <li>
          <strong>Reporting:</strong> We provide a "Notice and Action" link
          (a “Report” button or email) for reporting illegal content.
        </li>
        <li>
          <strong>Moderation:</strong> We reserve the right to remove content
          that violates Swedish or EU law (e.g., hate speech, CSAM,
          copyright infringement) without prior notice.
        </li>
        <li>
      ...
      <ul>
        <li>
          <strong>Right of Withdrawal:</strong> For digital services/subscriptions,
          Swedish consumers generally have a 14‑day right of withdrawal
          (<em>ångerrätt</em>).
        </li>
        <li>
          <strong>The Exception:</strong> If a user starts using the “Pro”
          features (e.g., uploads their first photo under a paid plan),
          they waive their right to the 14‑day refund period as the service
          has been “fully performed” or “initiated with consent.”
        </li>
        <li>
